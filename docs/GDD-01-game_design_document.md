...
| モンスター | 移動量 | 設計意図 |
| :--- | :--- | :--- |
| サラマンダー (Red/1) | +5, +9, +10 (各3枚) | 最大移動力。1枚で局面を変えうる「エース枠」 |
| フェニックス (Orange/2) | +5, +6, +8 (各3枚) | 安定の中高移動力 |
| グリフォン (Green/3) | +4, +5, +7 (各3枚) | 中移動力 |
| ケルピー (Blue/4) | +4, +5, +6 (各3枚) | 低〜中移動力 |
| ワイバーン (Purple/5) | +3, +4, +5 (各3枚) | 最小移動力。高オッズ馬として配当を高める役割 |
